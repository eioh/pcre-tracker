...
export const tableWrapClass =
  "h-[70vh] overflow-auto rounded-[14px] border border-table-wrap-border bg-table-wrap-bg [overscroll-behavior-x:contain] [scrollbar-gutter:stable] [contain:layout_paint_size]";
