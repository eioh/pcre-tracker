...
export const tableWrapClass =
  "h-[70vh] overflow-auto overscroll-contain rounded-[14px] border border-table-wrap-border bg-table-wrap-bg [scrollbar-gutter:stable] [contain:layout_paint_size]";
